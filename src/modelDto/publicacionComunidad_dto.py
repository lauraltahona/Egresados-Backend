...
class PublicacionComunidadDto(BaseModel):
    ...
    tituloPublicacion: Optional[str] = Field(None, min_length=5, max_lenght=100, pattern=r"^[A-Za-zñÑáéíóúÁÉÍÓÚ0-9\s]+$")
    contenidoPublicacion: Optional[str] | None = Field(None, min_length=5, max_lenght=2000, pattern=r"^[A-Za-zñÑáéíóúÁÉÍÓÚ0-9\s]+$")
